...
@Component
public class NewsAdapterMaeil {
    private final WebClient googleNewsClient;

    public NewsAdapterMaeil(@Qualifier("googleNewsClient") WebClient googleNewsClient) {
    ...
    public reactor.core.publisher.Mono<List<Map<String, Object>>> fetch(String query, int count, String lang) {
        ...
        String q = URLEncoder.encode("site:mk.co.kr " + query, StandardCharsets.UTF_8);
