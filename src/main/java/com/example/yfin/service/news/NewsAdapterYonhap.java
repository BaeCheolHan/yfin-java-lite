...
@Component
public class NewsAdapterYonhap {
    private final WebClient googleNewsClient;

    public NewsAdapterYonhap(@Qualifier("googleNewsClient") WebClient googleNewsClient) {
    ...
    public reactor.core.publisher.Mono<List<Map<String, Object>>> fetch(String query, int count, String lang) {
        ...
        String q = URLEncoder.encode("site:yna.co.kr " + query, StandardCharsets.UTF_8);
